        ...
        stage('Create Provider + Infra') {
            steps {
                ...
                ${YBA_BIN} provider onprem create \
                  ...
                  -H ${YBA_HOST} --insecure || echo "Provider exists"
                ...
                ${YBA_BIN} provider onprem instance-type add \
                  ...
                  -H ${YBA_HOST} --insecure || echo "Instance type exists"
                """
            }
        }
        ...
        stage('Create Universe') {
            steps {
                ...
                ${YBA_BIN} universe create \
                  ...
                  -H ${YBA_HOST} --insecure || echo "Universe may already exist"
                """
            }
        }
            ...
            steps {
                ...
                for i in {1..60}; do
                  STATUS=$('"${YBA_BIN}"' universe describe \
                    --name '"${UNIVERSE_NAME}"' \
                    -H '"${YBA_HOST}"' --insecure | grep Ready)
